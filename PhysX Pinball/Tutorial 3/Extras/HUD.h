...
namespace VisualDebugger
{
	...
	public:
		...
		// Update current text lines: for timer and best time
		void UpdateLine(string line, int line_num)
		{
	...
	public:
		...
		// Update specific line with new values
		void UpdateLine(int screen_id, string line, int line_num)
		{
			screens[screen_id]->UpdateLine(line, line_num);
		}
